  ...
  return (
    <section className="shell pb-12 pt-8 md:pt-12">
      <div className="card-surface p-7 md:p-9">
        ...
        <h1 className="mt-4 font-display text-5xl tracking-[-0.05em]">Perritos que hoy están buscando hogar</h1>
        <p className="mt-4 max-w-3xl text-base leading-8 text-black/62">
          Acá vas a encontrar los perros que hoy están disponibles para adopción, con nombre, edad y ubicación.
        </p>
      </div>
